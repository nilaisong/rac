...
-(void)tuple
{
    RACTuple* tuple = RACTuplePack(@404,@"http error");
    RACTupleUnpack(NSNumber* code,NSString* errorDesc) = tuple;
    NSLog(@"code:%d,error:%@",[code intValue],errorDesc);
}
